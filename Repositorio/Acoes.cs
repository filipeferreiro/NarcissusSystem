...
namespace NarcissusSystem.Repositorio
{
    public class Acoes
    {
        ...
        public void CadastrarEspecialista(Especialista especialista)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("insert into Especialista values(@IDEspecialista,  @DataNascEspec, @NomeEspec, @cpfEspec, @EmailEspec, @NumEspec)", con.MyConectarBD());
